...
public class OutportInternalFrame extends JInternalFrame implements ActionListener{
	 ...
	 * Create the frame.
	 */
	public OutportInternalFrame() {
		//支持放大缩小，可关闭
		super("入库退货查询",true,true,true,true);
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"退货单号", "供应商名称", "商品名称", "经手人"}));
		...
		//创建表格魔板
		String[] columnNames = {"退货单号","商品名称","商品数量","合计金额","供应商名称"
	...
	public void actionPerformed(ActionEvent e) {
		...
		switch (target) {
			...
			case "查询":
				...
				List<InportInfor> customers = outPortService.queryInportInfors(customer);
				if(customers!=null) {
				...
				break;
			case "显示全部信息":
				List<InportInfor> customers1 = outPortService.queryInportInfors(null);
				if(customers1!=null) {
					Vector<InportInfor> list = new Vector<InportInfor>();
